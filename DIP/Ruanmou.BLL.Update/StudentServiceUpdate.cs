...
namespace Ruanmou.BLL.Update
{
    /// <summary>
    /// 业务逻辑层，完成对业务逻辑的封装
    /// </summary>
    public class StudentServiceUpdate : IStudentService
    {
        public void Study()
        {
            Console.WriteLine("跟着Eleven老师一起学习.net高级开发 Update");
        }
        ...
        {
            Console.WriteLine("Use {0} Update", phone.GetType().Name);
            phone.Call();
            phone.Text();
        }
